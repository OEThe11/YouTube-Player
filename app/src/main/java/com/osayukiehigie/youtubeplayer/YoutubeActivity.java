...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyDfjhRH5ZrseD5f2Gv1kDeFS-cetEIdJ0s";
    static final String YOUTUBE_VIDEO_ID = "51jY_1E-Bjo";
    static final String YOUTUBE_PLAYLIST = "PLFRPkMZweFfZS9oX3um_lYsCnDTd105QB";
